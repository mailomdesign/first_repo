...
<div class="skills-grid scroll-fade">
  <div class="skill-column">
    ...
    <div class="tool">Photoshop<br> Lightroom</div>
    <div class="dots">
  ...
  <div class="skill-column">
    ...
    <div class="tool">Illustrator<br> CorelDRAW</div>
    <div class="dots">
      <div class="dot"></div><div class="dot"></div><div class="dot"></div>
  ...
  <div class="skill-column">
    ...
    <div class="tool">InDesign<br> QuarkXPress</div>
    <div class="dots">
      <div class="dot"></div><div class="dot"></div><div class="dot"></div>
      <div class="dot"></div><div class="dot"></div><div class="dot"></div>
    </div>
  ...
  <div class="skill-column">
    <div class="skill-label">препресс</div>
...
<div id="feedbackModal" class="modal">
  <div class="modal-content">
    ...
    >
      ...
      <div class="consent">
        ...
        <label for="consent" class="consent-label">
          Я принимаю
          <a href="privacy-policy.html">условия использования и политику конфиденциальности</a>
          и даю
          <a href="personal-data.html">согласие на обработку персональных данных</a>
        </label>
      </div>
    ...
    <!-- СООБЩЕНИЕ ОБ УСПЕХЕ (пока скрыто) -->
